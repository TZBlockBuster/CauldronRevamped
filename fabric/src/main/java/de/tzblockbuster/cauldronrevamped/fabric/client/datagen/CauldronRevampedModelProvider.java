...
public class CauldronRevampedModelProvider extends FabricModelProvider {
    ...
    public void generateCauldronModels(BlockModelGenerators blockModelGenerators) {
        ...
        Identifier laval_cauldron_full = ModelTemplates.CAULDRON_FULL.createWithSuffix(Blocks.LAVA_CAULDRON, "_full", TextureMapping.cauldron(Identifier.withDefaultNamespace("block/cauldron")).put(TextureSlot.CONTENT, Identifier.withDefaultNamespace("block/lava_still")), blockModelGenerators.modelOutput);
        Identifier laval_cauldron_level1 = ModelTemplates.CAULDRON_LEVEL1.createWithSuffix(Blocks.LAVA_CAULDRON, "_level1", TextureMapping.cauldron(Identifier.withDefaultNamespace("block/cauldron")).put(TextureSlot.CONTENT, Identifier.withDefaultNamespace("block/lava_still")), blockModelGenerators.modelOutput);
        Identifier laval_cauldron_level2 = ModelTemplates.CAULDRON_LEVEL2.createWithSuffix(Blocks.LAVA_CAULDRON, "level_2", TextureMapping.cauldron(Identifier.withDefaultNamespace("block/cauldron")).put(TextureSlot.CONTENT, Identifier.withDefaultNamespace("block/lava_still")), blockModelGenerators.modelOutput);

        blockModelGenerators.blockStateOutput.accept(MultiPartGenerator.multiPart(Blocks.LAVA_CAULDRON)
                .with(BlockModelGenerators.condition().term(LayeredCauldronBlock.LEVEL, 3), BlockModelGenerators.plainVariant(laval_cauldron_full))
                .with(BlockModelGenerators.condition().term(LayeredCauldronBlock.LEVEL, 2), BlockModelGenerators.plainVariant(laval_cauldron_level2))
                .with(BlockModelGenerators.condition().term(LayeredCauldronBlock.LEVEL, 1), BlockModelGenerators.plainVariant(laval_cauldron_level1))
        );
    }
